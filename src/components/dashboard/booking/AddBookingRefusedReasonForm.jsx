...
import { addBookings } from "../../../services/post/dashboard/addBookings";
const AddBookingRefusedReasonForm = ({
  showBookingForm,
  setShowBookingForm,
}) => {
  ...
  return (
    <div
      className={`duration-300 fixed top-0 ${
        showBookingForm ? "left-0" : "left-[-400%]"
...
export default AddBookingRefusedReasonForm;

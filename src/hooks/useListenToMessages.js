...
const useListenToMessages = () => {
  ...
  const addMessage = async (e) => {
    ...
    if(splittedLocation.find(path => chatURLs.find(chatURL => chatURL.toLowerCase() === path.toLowerCase())) && receiverId) {
      try{
    ...
    queryClient.setQueryData(["notifications", "messages"], (oldNotifications) => {
